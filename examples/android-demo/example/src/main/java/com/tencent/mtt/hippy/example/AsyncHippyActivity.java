...
public abstract class AsyncHippyActivity extends Activity
{
            ...
            mHippyEngine.initEngine(new HippyEngine.EngineListener() {
                ...
                public void onInitialized(int statusCode, String msg) {
                    ...
                    // else
                    {
                        ...
                        loadParams.context = AsyncHippyActivity.this;
						/*
						  ...
						  */
                        loadParams.componentName = getModuleName();
						/*
						 ...
						 */
                        loadParams.jsAssetsPath = getModulePath();
						/*
    ...
    public void onBackPressed() {
        ...
        boolean handled = mHippyEngine.onBackPressed(new HippyEngine.BackPressHandler() {
            ...
            public void handleBackPress() {
                AsyncHippyActivity.this.doActivityBack();
            }
        });
        if (!handled)
            super.onBackPressed();
